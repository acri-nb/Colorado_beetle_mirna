...
runcmd(cmd, runlog )
cmd='/results/plugins/smallRNA/scripts/mirBaseAlignmentFilter.pl --maxMismatches 1 --maxIndels 1 --maxEdit 2 --max5pSoftClipping 0 --max3pSoftClipping 3 --maxReadLength 35 --minAlignLength 16 --mapper bowtie2 --bam project02122019/IonXpressRNA_018.bam --mirbase_gff new_lde_nameChanged.gtf --goutput project02122019/IonXpressRNA_018_filtered.bam --padding 10 --genome /results/referenceLibrary/tmap-f3/Ldec2.0/Ldec2.0.fasta --filteredOut project02122019/IonXpressRNA_018.filtered_out.sam --alignStats project02122019/IonXpressRNA_018.filterstats.txt --mirnaMappingType mirbase --minMQV 0 --pluginDir /results/plugins/smallRNA --controlPrefix ControlSeq_ --controlOutput project02122019/IonXpressRNA_018.control.bam > project02122019/IonXpressRNA_018AlignmentFilter.log 2> project02122019/IonXpressRNA_018mirbasealignment.log';
runcmd(cmd, runlog )
